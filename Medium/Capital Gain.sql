...
t2 as (select stock_name, sum(price) as total_buy
from Stocks
where operation='Buy'
group by stock_name)

select t1.stock_name, t1.total_sell-t2.total_buy as capital_gain_loss
from t1 left join t2 on t1.stock_name=t2.stock_name
